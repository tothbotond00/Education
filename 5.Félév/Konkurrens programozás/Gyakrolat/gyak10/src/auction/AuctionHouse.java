...
public class AuctionHouse {
    ...
    // TODO for Task 3: data structure "owners" Currently dummy
    static List<Integer> owners = new ArrayList<>();
    ...
    private static Thread makeAuctioneer(List<Thread> artists) {
            return new Thread(){
                ...
                Map<String,List<NFT>> owning = new HashMap<>();
                ...
                private void makeAuction(){
                    ...
                    if (bestOffer != null){
                        winners.add(bestOffer.collectorName);
                        if(owning.containsKey(bestOffer.collectorName))
                            owning.get(bestOffer.collectorName).add(randomNFT);
                        else{
                            List<NFT> list = new ArrayList();
                            list.add(randomNFT);
                            owning.put(bestOffer.collectorName, list);
                        }
                        soldItemCount++;
